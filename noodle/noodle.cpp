...
int main() 
{
  std::setlocale(LC_ALL, "");
    ...
    std::vector<std::string> name = {"выебал", "выебала", "трахнул", "рвет туз", "сосед", "соседа", "негр", "негра", "школьница",
                                     ...
                                     "огромный хуй", "брат", "брата", "сестра", "сестру", "татарка", "узбечка", "армянка", "казашка", "киргизка", "отец", "сестра", "училка", "африканка",                                       "камволк", "арабка", "рогоносец", "ленин", "аниме", "ахегао", "семейная пара", "foot", "горничная", "джени кити", "dota", "теща", "наблюдатель", "кондукторша";
